...
import LightBulbFillIcon from '../../assets/icons/lightbulb-fill.svg?react'
      ...
      <header className={styles.header}>
        ...
        <div className={styles.headerControlsMobile}>
          <button className={styles.themeButtonMobile} onClick={toggleTheme}>
            {theme === "light" ? (
              <LightBulbFillIcon
                className={`${styles.icon} ${styles.iconLightBulbFill}`}
              />
            ) : (
          ...
          <div
            className={`${styles.dropdownMenu} ${dropdownOpen ? "open" : ""}`}
          >
